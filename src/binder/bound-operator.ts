...
export class BoundBinaryOperator {
  ...
  private static operator = [
    ...
    new BoundBinaryOperator(SyntaxKind.EqualEqualEqualToken, BoundBinaryOperatorKind.StrictEqual, TypeSymbol.any, TypeSymbol.any, TypeSymbol.bool),
    new BoundBinaryOperator(SyntaxKind.ExclamationEqualEqualToken, BoundBinaryOperatorKind.StrictNotEqual, TypeSymbol.any),
    ...
    new BoundBinaryOperator(SyntaxKind.LessEqualGreaterToKen, BoundBinaryOperatorKind.SpaceShip, TypeSymbol.any, TypeSymbol.any, TypeSymbol.bool),
    ...
    new BoundBinaryOperator(SyntaxKind.StarStarToken, BoundBinaryOperatorKind.Expo, TypeSymbol.int),
    new BoundBinaryOperator(SyntaxKind.QuestionQuestionToken, BoundBinaryOperatorKind.Nullish, TypeSymbol.int),
